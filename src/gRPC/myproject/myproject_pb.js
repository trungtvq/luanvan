 ...
 * @return {string}
 */
proto.myproject.AddNewProjectReq.prototype.getOwnerid = function() {
  return /** @type {string} */ (jspb.Message.getFieldProto3(this, 1, ""));
};


/** @param {string} value  */
proto.myproject.AddNewProjectReq.prototype.setOwnerid = function(value) {
  jspb.Message.setField(this, 1, value);
};


/**
 * optional string requesterId = 7;
 * @return {string}
 */

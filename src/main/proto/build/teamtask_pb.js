...
goog.exportSymbol('proto.teamtask.SendTeamTaskToMyTaskReq', null, global);
 ...
 * @constructor
 */
proto.teamtask.SendTeamTaskToMyTaskReq = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.teamtask.SendTeamTaskToMyTaskReq, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.teamtask.SendTeamTaskToMyTaskReq.displayName = 'proto.teamtask.SendTeamTaskToMyTaskReq';
}
 ...
 * @return {!Object}
 */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.toObject = function(opt_includeInstance) {
  return proto.teamtask.SendTeamTaskToMyTaskReq.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.teamtask.SendTeamTaskToMyTaskReq} msg The msg instance to transform.
 * @return {!Object}
 */
proto.teamtask.SendTeamTaskToMyTaskReq.toObject = function(includeInstance, msg) {
  var f, obj = {
    requesterid: msg.getRequesterid(),
    projectid: msg.getProjectid(),
    title: msg.getTitle(),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.teamtask.SendTeamTaskToMyTaskReq}
 */
proto.teamtask.SendTeamTaskToMyTaskReq.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.teamtask.SendTeamTaskToMyTaskReq;
  return proto.teamtask.SendTeamTaskToMyTaskReq.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.teamtask.SendTeamTaskToMyTaskReq} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.teamtask.SendTeamTaskToMyTaskReq}
 */
proto.teamtask.SendTeamTaskToMyTaskReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * Class method variant: serializes the given message to binary data
 * (in protobuf wire format), writing to the given BinaryWriter.
 * @param {!proto.teamtask.SendTeamTaskToMyTaskReq} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.teamtask.SendTeamTaskToMyTaskReq.serializeBinaryToWriter = function(message, writer) {
  message.serializeBinaryToWriter(writer);
};
 ...
 * @return {!Uint8Array}
 */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  this.serializeBinaryToWriter(writer);
  return writer.getResultBuffer();
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getRequesterid();
  if (f.length > 0) {
    writer.writeString(
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.teamtask.SendTeamTaskToMyTaskReq} The clone.
 */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.cloneMessage = function() {
  return /** @type {!proto.teamtask.SendTeamTaskToMyTaskReq} */ (jspb.Message.cloneMessage(this));
};
 ...
 * @return {string}
 */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.getRequesterid = function() {
  return /** @type {string} */ (jspb.Message.getFieldProto3(this, 1, ""));
};


/** @param {string} value  */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.setRequesterid = function(value) {
  jspb.Message.setField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.getProjectid = function() {
  return /** @type {string} */ (jspb.Message.getFieldProto3(this, 2, ""));
};


/** @param {string} value  */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.setProjectid = function(value) {
  jspb.Message.setField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.getTitle = function() {
  return /** @type {string} */ (jspb.Message.getFieldProto3(this, 3, ""));
};


/** @param {string} value  */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.setTitle = function(value) {
  jspb.Message.setField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.getDescription = function() {
  return /** @type {string} */ (jspb.Message.getFieldProto3(this, 4, ""));
};


/** @param {string} value  */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.setDescription = function(value) {
  jspb.Message.setField(this, 4, value);
};
 ...
 * @return {string}
 */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.getPriority = function() {
  return /** @type {string} */ (jspb.Message.getFieldProto3(this, 5, ""));
};


/** @param {string} value  */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.setPriority = function(value) {
  jspb.Message.setField(this, 5, value);
};
 ...
 * @return {string}
 */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.getStart = function() {
  return /** @type {string} */ (jspb.Message.getFieldProto3(this, 6, ""));
};


/** @param {string} value  */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.setStart = function(value) {
  jspb.Message.setField(this, 6, value);
};
 ...
 * @return {string}
 */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.getDeadline = function() {
  return /** @type {string} */ (jspb.Message.getFieldProto3(this, 7, ""));
};


/** @param {string} value  */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.setDeadline = function(value) {
  jspb.Message.setField(this, 7, value);
};
 ...
 * @return {string}
 */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.getComment = function() {
  return /** @type {string} */ (jspb.Message.getFieldProto3(this, 8, ""));
};


/** @param {string} value  */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.setComment = function(value) {
  jspb.Message.setField(this, 8, value);
};
 ...
 * @return {string}
 */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.getStatus = function() {
  return /** @type {string} */ (jspb.Message.getFieldProto3(this, 9, ""));
};


/** @param {string} value  */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.setStatus = function(value) {
  jspb.Message.setField(this, 9, value);
};


/**
 * optional string teamTaskId = 11;
 * @return {string}
 */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.getTeamtaskid = function() {
  return /** @type {string} */ (jspb.Message.getFieldProto3(this, 11, ""));
};


/** @param {string} value  */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.setTeamtaskid = function(value) {
  jspb.Message.setField(this, 11, value);
};
 ...
 * @return {string}
 */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.getAccesstoken = function() {
  return /** @type {string} */ (jspb.Message.getFieldProto3(this, 10, ""));
};


/** @param {string} value  */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.setAccesstoken = function(value) {
  jspb.Message.setField(this, 10, value);
};
 ...
 * @return {string}
 */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.getTeamid = function() {
  return /** @type {string} */ (jspb.Message.getFieldProto3(this, 13, ""));
};


/** @param {string} value  */
proto.teamtask.SendTeamTaskToMyTaskReq.prototype.setTeamid = function(value) {
  jspb.Message.setField(this, 13, value);
};

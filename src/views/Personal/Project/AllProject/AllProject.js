                ...
                <Card>
                      <CardHeader>
                        <strong>Web </strong>
                            ...
                            <Button color="primary" size="sm" onClick={that.toggleAdd}><i class="fa fa-plus-square"></i>{this.props.buttonLabel}</Button>
                                      ...
                                      <CardHeader>
                                       <Link to="/DashBoard">
                                        ...
                                        <div className="card-header-actions">
                                         <a href="/Project/Setting" className="card-header-action btn btn-setting"><i className="icon-trash"></i></a>
                                        </div>
                                      </CardHeader>
                                      <CardBody>        
